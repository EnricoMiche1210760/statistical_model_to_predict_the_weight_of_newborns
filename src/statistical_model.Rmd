...
lunghezza_density.plot <- ggplot(data = newborns_dataset, aes(x = Lunghezza)) +
                        geom_density(color = "blue") +
                        geom_vline(xintercept = quantile(newborns_dataset$Lunghezza, 0.25), color = "red") +
                        geom_vline(xintercept = quantile(newborns_dataset$Lunghezza, 0.75), color = "red") +
                        labs(x = "Lunghezza", y = "Density") +
                        theme_minimal()+
                        theme(panel.grid.major = element_blank(),
                            panel.grid.minor = element_blank())

peso_density.plot <- ggplot(data = newborns_dataset, aes(x = Peso)) +
                    geom_density(color = "blue") +
                    geom_vline(xintercept = quantile(newborns_dataset$Peso, 0.25), color = "red") +
                    geom_vline(xintercept = quantile(newborns_dataset$Peso, 0.75), color = "red") +
                    labs(x = "Peso", y = "Density")+
                    theme_minimal()+
                    theme(panel.grid.major = element_blank(),
                        panel.grid.minor = element_blank())
...
#TODO: DEVO METTERE GLI GLI ASSI IN NERO !!!!!
#TOD: AGGIORNARE IL NUMERO DELLA FIGURA!!!!
...
```{r anni_madre_cl_distr, results='asis', fig.align='center', echo=FALSE}
...
barplot(freq_distr$ni,
        ylim = c(0,240),
        col = "aquamarine4",
        main = "Frequency distribution of \"Anni.madre\" class",
        names.arg = rownames(freq_distr))
